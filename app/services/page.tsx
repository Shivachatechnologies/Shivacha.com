...
const SERVICES = [
  {
    icon: '⛓️', title: 'Blockchain Development', href: '/services/blockchain-development', color: '#006FEE',
      ...
      <section className="section relative overflow-hidden grid-bg">
        ...
        <div className="container relative z-10 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <h1 className="h1 text-[#F0F6FF] mb-6">Enterprise Development <br /><span className="gt-blue">Services</span></h1>
      ...
      <section className="section bg-[#0C1428]">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-6">
            {SERVICES.map((s) => (
              <div key={s.href} className="card rounded-3xl p-7 border border-white/[0.06] hover:border-slate-300 group">
                <div className="flex items-start gap-4 mb-4">
                  <div className="text-4xl flex-shrink-0">{s.icon}</div>
                  <div>
                    <h2 className="text-[18px] font-bold text-[#F0F6FF] group-hover:text-[#338EF7] transition-colors mb-1">{s.title}</h2>
                ...
                <p className="text-[14px] text-[rgba(240,246,255,0.40)] leading-relaxed mb-4">{s.desc}</p>
                <div className="grid grid-cols-2 gap-2 mb-5">
                  {s.features.map((f) => (
                    <div key={f} className="flex items-center gap-2 text-[12px] text-[rgba(240,246,255,0.35)]">
