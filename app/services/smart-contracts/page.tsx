  ...
  return (
    <div className="bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:block">
              <div className="glass rounded-3xl p-7 border border-white/[0.06] relative overflow-hidden">
                ...
                <p className="text-[12px] text-[rgba(240,246,255,0.35)] uppercase tracking-wider mb-4">Smart Contract Lifecycle</p>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={step} className="flex items-center gap-3 p-3 rounded-xl bg-[#0C1428] border border-white/[0.06]">
                      ...
                      <span className="text-[13px] text-[rgba(240,246,255,0.40)] flex-1">{label}</span>
      ...
      <section className="section bg-[#0C1428]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="h2 text-[#F0F6FF]">Smart Contract <span style={{ color: '#6644FF' }}>Development Services</span></h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {OFFERINGS.map((o) => (
              <div key={o.title} className="card rounded-2xl p-6 border border-white/[0.06] hover:border-slate-300 group">
                ...
                <h3 className="text-[16px] font-bold text-[#F0F6FF] mb-2 group-hover:transition-colors" style={{ '--hover-color': '#a78bfa' } as React.CSSProperties}>{o.title}</h3>
      ...
      <section className="section-sm bg-white">
        <div className="container">
          <div className="text-center mb-10">
            <h2 className="h3 text-[#F0F6FF]">Chains & <span style={{ color: '#6644FF' }}>Runtimes</span> We Support</h2>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-8 gap-3">
            {CHAINS.map((c) => (
              <div key={c.name} className="card rounded-xl p-4 text-center border border-white/[0.06] hover:border-[#6644FF]/40 group cursor-default">
      ...
      <section className="section bg-[#0C1428]">
        <div className="container">
          <div className="text-center mb-10">
            <h2 className="h3 text-[#F0F6FF]">Security <span style={{ color: '#6644FF' }}>Toolchain</span></h2>
            <p className="text-[rgba(240,246,255,0.40)] mt-2 max-w-lg mx-auto text-[14px]">Industry-standard tools combined with our proprietary audit checklist.</p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
            {TOOLS.map((t) => (
              <div key={t.name} className="card rounded-xl p-4 border border-white/[0.06] text-center hover:border-[#6644FF]/40">
                <p className="text-[14px] font-bold text-[#F0F6FF] mb-1">{t.name}</p>
      ...
      <section className="section bg-white">
        <div className="container max-w-3xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="h3 text-[#F0F6FF]">Shivacha vs <span style={{ color: '#6644FF' }}>Typical Agency</span></h2>
          </div>
      ...
      <section className="section bg-[#0C1428]">
        <div className="container">
          <div className="text-center mb-10">
            <h2 className="h3 text-[#F0F6FF]">Smart Contract <span style={{ color: '#6644FF' }}>Use Cases</span></h2>
          </div>
      ...
      <section className="section bg-white">
        <div className="container max-w-3xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="h3 text-[#F0F6FF]">Frequently Asked <span style={{ color: '#6644FF' }}>Questions</span></h2>
          </div>
