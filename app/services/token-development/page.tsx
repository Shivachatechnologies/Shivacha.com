          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:block">
              <div className="glass-lg rounded-3xl p-7 border border-[#0E1E34] relative overflow-hidden">
                ...
                <p className="text-[12px] text-[#3D5470] uppercase tracking-wider mb-4">Token Launch Overview</p>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={r.label} className="flex items-center justify-between p-3 rounded-xl bg-[#060E1C] border border-[#0E1E34]">
                      <div className="flex items-center gap-2">
                        <span>{r.icon}</span>
                        <span className="text-[12px] text-[#3D5470]">{r.label}</span>
                      </div>
                      <span className="text-[13px] font-semibold text-white">{r.value}</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section className="section bg-[#020B18]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="h2 text-white">Tokens We <span className="gt-blue">Design & Build</span></h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {TOKEN_TYPES.map(t => (
              <div key={t.title} className="card rounded-2xl p-6 border border-[#0E1E34] hover:border-[#00FF87]/30 group">
                <div className="text-4xl mb-4">{t.icon}</div>
                <h3 className="text-[15px] font-bold text-white mb-2 group-hover:text-[#33B5E5] transition-colors">{t.title}</h3>
                <p className="text-[13px] text-[#7A8FA6] leading-relaxed mb-3">{t.desc}</p>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="h2 text-white mb-4">Everything Included in <span className="gt-blue">Your Token Launch</span></h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              {CHECKLIST.map(c => (
                <div key={c} className="flex items-center gap-2.5 p-3 rounded-xl bg-[#060E1C] border border-[#0E1E34]">
      ...
      <section className="section-sm bg-[#020B18]">
        <div className="container">
          <div className="text-center mb-8">
            <h2 className="h3 text-white">Chains We <span className="gt-blue">Deploy On</span></h2>
          </div>
          <div className="flex flex-wrap justify-center gap-3">
            {CHAINS.map(c => (
              <div key={c.name} className="flex items-center gap-2.5 px-4 py-3 rounded-xl bg-[#060E1C] border border-[#0E1E34] hover:border-[#1E3A5A]">
