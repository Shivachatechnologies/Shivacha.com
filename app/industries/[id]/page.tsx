        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="h2 text-[#F0F6FF] mb-4">Problems We <span className="gt-blue">Solve</span></h2>
              ...
              <div className="space-y-3">
                {industry.challenges.map((c, i) => (
                  <div key={i} className="flex items-start gap-3 p-3 rounded-xl bg-[#0C1428] border border-white/[0.06]">
                    ...
                    <span className="text-[13px] text-[rgba(240,246,255,0.40)] leading-relaxed">{c}</span>
                  </div>
                ))}
              </div>
            </div>
            <div>
              ...
              <h3 className="h3 text-[#F0F6FF] mb-4">Regulatory <span className="gt-blue">Frameworks</span></h3>
              <div className="grid grid-cols-2 gap-2 mb-6">
                {industry.compliance.map(c => (
                  <div key={c} className="flex items-center gap-2 p-3 rounded-xl bg-[#0C1428] border border-white/[0.06]">
              ...
              <p className="text-[13px] text-[rgba(240,246,255,0.35)]">
                <span className="text-[rgba(240,246,255,0.40)] font-medium">Typical clients:</span> {industry.clients}
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="h2 text-[#F0F6FF]">What We Build for <span style={{ color: industry.color }}>{industry.name}</span></h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {industry.solutions.map((s) => (
              <div key={s.title} className="card rounded-2xl p-6 border border-white/[0.06] hover:border-slate-300 group">
