            ...
            <div className="hidden lg:block">
              <div className="dashboard-preview rounded-2xl relative">
                ...
                <div className="dashboard-bar">
                  ...
                  <span className="ml-3 text-[11px] text-[#3D5470]">cloud.shivacha.com — Node Console</span>
                </div>
                <div className="p-5 space-y-3">
                  ...
                  <div className="space-y-1.5">
                    {[
                      ...
                      <div key={String(chain)} className="flex items-center gap-2 glass rounded-lg px-3 py-2">
                        ...
                        <span className="text-[11px] font-semibold text-white w-24">{chain}</span>
                        <span className="text-[10px] text-[#3D5470] flex-1">{type}</span>
                        <span className="text-[10px] text-green-400">{status}</span>
                        <span className="text-[10px] text-[#3D5470]">{region}</span>
                      </div>
                    ))}
                  </div>
                  {/* Metrics */}
                  ...
                  <div className="glass rounded-xl p-3">
                    <p className="text-[10px] text-[#3D5470] uppercase tracking-wider mb-2">90-Day Uptime</p>
      ...
      <section className="section bg-[#020B18]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="h2 text-white mb-4">Every Layer Your <span style={{ color: COLOR }}>Web3 Stack Needs</span></h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {FEATURES.map(f => (
              <div key={f.title} className="card rounded-2xl p-6 border border-[#0E1E34] hover:border-[#14B8A6]/30 transition-colors group">
                <div className="text-3xl mb-4">{f.icon}</div>
                <h3 className="text-[15px] font-bold text-white mb-2 group-hover:text-[#5EEAD4] transition-colors">{f.title}</h3>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="h2 text-white mb-6">Hardware Built for <span style={{ color: COLOR }}>Blockchain Workloads</span></h2>
              ...
              <div className="space-y-2">
                {SPECS.map(s => (
                  <div key={s.label} className="flex items-start gap-4 p-4 glass rounded-xl border border-[#0E1E34]">
                    <span className="text-[12px] font-bold text-[#3D5470] uppercase tracking-wider w-24 flex-shrink-0 pt-0.5">{s.label}</span>
            ...
            <div>
              ...
              <h3 className="h3 text-white mb-6">20+ Chains, Fully Managed</h3>
              ...
              <div className="glass-lg rounded-2xl p-6 border border-[#0E1E34]">
                <p className="text-[12px] text-[#3D5470] uppercase tracking-wider mb-4">Global Data Centre Locations</p>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={String(region)} className="flex items-start gap-3">
                      ...
                      <div>
                        <span className="text-[13px] font-semibold text-white">{region}</span>
                        <span className="text-[12px] text-[#3D5470]"> — {address}</span>
                      </div>
                    </div>
                  ))}
                </div>
      ...
      <section className="section bg-[#020B18]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="h2 text-white mb-4">Built for <span style={{ color: COLOR }}>Every Web3 Workload</span></h2>
          </div>
          <div className="grid md:grid-cols-4 gap-5">
            {[
              ...
              <div key={u.title} className="card rounded-2xl p-6 border border-[#0E1E34] hover:border-[#14B8A6]/30 transition-colors">
