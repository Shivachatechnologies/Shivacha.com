            ...
            <div className="hidden lg:block">
              <div className="dashboard-preview rounded-2xl relative">
                ...
                <div className="dashboard-bar">
                  ...
                  <span className="ml-3 text-[11px] text-[#3D5470]">trading-bots.platform — Strategy Dashboard</span>
                </div>
                <div className="p-5 space-y-3">
                  <div className="grid grid-cols-2 gap-2">
                    {[
                      ['Total P&L', '+$124,540', 'text-green-400'],
                      ['Sharpe Ratio', '2.34', 'text-white'],
                      ['Max Drawdown', '-4.2%', 'text-red-400'],
                      ['Win Rate', '67.8%', 'text-white'],
                    ].map(([label, value, cls]) => (
                      <div key={String(label)} className="p-3 rounded-xl bg-[#060E1C] border border-[#0E1E34]">
                        <p className="text-[10px] text-[#3D5470] uppercase mb-1">{label}</p>
                  ...
                  <div className="glass rounded-xl p-3">
                    <p className="text-[10px] text-[#3D5470] uppercase tracking-wider mb-2">30-Day Equity Curve</p>
                  ...
                  <div className="space-y-1.5">
                    {[
                      ...
                      <div key={String(name)} className="flex items-center gap-3 p-2.5 rounded-lg bg-[#060E1C] border border-[#0E1E34]">
                        <div className={`w-2 h-2 rounded-full flex-shrink-0 ${status === 'running' ? 'bg-green-400 animate-pulse' : 'bg-yellow-400'}`} />
                        <span className="text-[11px] text-[#7A8FA6] flex-1">{name}</span>
      ...
      <section className="section bg-[#020B18]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="h2 text-white mb-4">Everything to Run <span style={{ color: COLOR }}>Algorithmic Trading</span></h2>
            <p className="lead">From idea to live strategy — one platform for the entire algo trading lifecycle.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {FEATURES.map(f => (
              <div key={f.title} className="card rounded-2xl p-6 border border-[#0E1E34] hover:border-[#EF4444]/30 transition-colors group">
                <div className="text-3xl mb-4">{f.icon}</div>
                <h3 className="text-[15px] font-bold text-white mb-2 group-hover:text-[#FCA5A5] transition-colors">{f.title}</h3>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="h2 text-white mb-6">Built for <span style={{ color: COLOR }}>Institutional Speed</span></h2>
            ...
            <div>
              ...
              <h3 className="h3 text-white mb-6">30+ Venues, One Unified API</h3>
              ...
              <div className="glass-lg rounded-2xl p-6 border border-[#0E1E34]">
                <p className="text-[12px] text-[#3D5470] uppercase tracking-wider mb-4">Built-In Risk Controls</p>
                <div className="space-y-2">
                  {[
                    ...
                    <div key={rc} className="flex items-center gap-3">
                      ...
                      <span className="text-[13px] text-[#7A8FA6]">{rc}</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section className="section bg-[#020B18]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="h2 text-white mb-4">Built for <span style={{ color: COLOR }}>Every Trading Profile</span></h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={u.title} className="card rounded-2xl p-7 border border-[#0E1E34] hover:border-[#EF4444]/30 transition-colors">
