            ...
            <div className="hidden lg:block">
              <div className="dashboard-preview rounded-2xl relative">
                ...
                <div className="dashboard-bar">
                  ...
                  <span className="ml-3 text-[11px] text-[rgba(240,246,255,0.35)]">custody.platform — Wallet Console</span>
                </div>
                <div className="p-5 space-y-3">
                  <div className="glass rounded-xl p-3 border border-white/[0.06]">
                    <p className="text-[10px] text-[rgba(240,246,255,0.35)] uppercase tracking-wider mb-1">Total Assets Under Custody</p>
                    ...
                    <div className="flex gap-3 mt-1">
                      ...
                      <span className="text-[10px] text-[rgba(240,246,255,0.35)]">•</span>
                      <span className="text-[10px] text-[rgba(240,246,255,0.40)]">Cold: $235.9M</span>
                    </div>
                  </div>
                  <div className="space-y-1.5">
                    {[
                      ...
                      <div key={String(chain)} className="flex items-center gap-2.5 glass rounded-lg px-3 py-2">
                        ...
                        <span className="text-[11px] font-semibold text-[#F0F6FF] flex-1">{chain}</span>
                        <span className="text-[10px] text-[rgba(240,246,255,0.35)]">{amt}</span>
                        <span className="text-[11px] font-bold text-[#F0F6FF]">{usd}</span>
      ...
      <section className="section bg-[#0C1428]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="h2 text-[#F0F6FF] mb-4">Security-First <span style={{ color: COLOR }}>Custody Infrastructure</span></h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {FEATURES.map(f => (
              <div key={f.title} className="card rounded-2xl p-6 border border-white/[0.06] hover:border-[#A855F7]/30 transition-colors group">
                <div className="text-3xl mb-4">{f.icon}</div>
                <h3 className="text-[15px] font-bold text-[#F0F6FF] mb-2 group-hover:text-[#C084FC] transition-colors">{f.title}</h3>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="h2 text-[#F0F6FF] mb-6">Zero Single Point <span style={{ color: COLOR }}>of Failure</span></h2>
            ...
            <div>
              ...
              <h3 className="h3 text-[#F0F6FF] mb-6">Enterprise-Grade Security Standards</h3>
              ...
              <div className="glass-lg rounded-2xl p-6 border border-white/[0.06]">
                <p className="text-[12px] text-[rgba(240,246,255,0.35)] uppercase tracking-wider mb-4">Security Checklist</p>
                <div className="space-y-2.5">
                  {[
                    ...
                    <div key={sf} className="flex items-center gap-3">
                      ...
                      <span className="text-[13px] text-[rgba(240,246,255,0.40)]">{sf}</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section className="section bg-[#0C1428]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="h2 text-[#F0F6FF] mb-4">Built for <span style={{ color: COLOR }}>Institutional Operators</span></h2>
          </div>
          <div className="grid md:grid-cols-4 gap-5">
            {[
              ...
              <div key={u.title} className="card rounded-2xl p-6 border border-white/[0.06] hover:border-[#A855F7]/30 transition-colors">
