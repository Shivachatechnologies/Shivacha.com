            ...
            <div className="hidden lg:block">
              <div className="dashboard-preview rounded-2xl relative">
                ...
                <div className="dashboard-bar">
                  ...
                  <span className="ml-3 text-[11px] text-[#3D5470]">exchange.yourbrand.com — Live Trading</span>
                </div>
                <div className="p-5 space-y-3">
                  ...
                  <div className="flex gap-3 overflow-hidden">
                    {[['BTC/USDT','$67,420','↑2.4%','text-green-400'],['ETH/USDT','$3,521','↑1.8%','text-green-400'],['BNB/USDT','$598','↓0.3%','text-red-400'],['SOL/USDT','$182','↑5.1%','text-green-400']].map(([pair,price,chg,cls]) => (
                      <div key={pair} className="glass rounded-lg px-3 py-1.5 flex-shrink-0">
                        <p className="text-[10px] text-[#3D5470]">{pair}</p>
                        <p className="text-[13px] font-bold text-white">{price}</p>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="col-span-2 glass rounded-xl p-3 h-36 flex flex-col justify-between">
                      <p className="text-[10px] text-[#3D5470] uppercase tracking-wider">Price Chart — BTC/USDT</p>
                    ...
                    <div className="glass rounded-xl p-3 h-36 flex flex-col gap-1 overflow-hidden">
                      <p className="text-[10px] text-[#3D5470] uppercase tracking-wider mb-1">Order Book</p>
                      {[['67,580','0.42','sell'],['67,560','1.10','sell'],['67,540','0.77','sell'],['—','—','mid'],['67,420','2.31','buy'],['67,400','0.98','buy'],['67,380','1.54','buy']].map(([p,a,s],i) => (
                        <div key={i} className={`flex justify-between text-[9px] font-mono ${s==='sell'?'text-red-400':s==='buy'?'text-green-400':'text-[#3D5470]'}`}>
      ...
      <section className="section bg-[#020B18]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="h2 text-white mb-4">Everything You Need to <span className="gt-blue">Run an Exchange</span></h2>
            <p className="lead">One platform. Every feature a competitive exchange needs — from matching engine to mobile app.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {FEATURES.map(f => (
              <div key={f.title} className="card rounded-2xl p-6 border border-[#0E1E34] hover:border-[#0099E6]/40 group">
                <div className="text-4xl mb-4">{f.icon}</div>
                <h3 className="text-[16px] font-bold text-white mb-2 group-hover:text-[#33B5E5] transition-colors">{f.title}</h3>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="h2 text-white mb-6">Built for <span className="gt-blue">Institutional Scale</span></h2>
            ...
            <div>
              ...
              <div className="glass-lg rounded-2xl p-6 border border-[#0E1E34]">
                <p className="text-[12px] text-[#3D5470] uppercase tracking-wider mb-4">Performance Benchmarks</p>
      ...
      <section className="section bg-[#020B18]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="h2 text-white mb-4">From Contract to <span className="gt-blue">Live Exchange</span></h2>
            <p className="lead">A proven 8-week delivery process used across 50+ exchange launches worldwide.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {STEPS.map((s, i) => (
              <div key={s.n} className="card rounded-2xl p-6 border border-[#0E1E34] relative group hover:border-[#0099E6]/40">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[['$200M','Daily Trading Volume at Peak'],['180K','Registered Users — Month 6'],['7 Weeks','Time to Full Production Launch'],['45M+','Trades Processed — First Quarter'],['99.99%','Platform Uptime — Year One'],['3','Liquidity Providers Integrated']].map(([v, l]) => (
                <div key={l} className="glass-lg rounded-2xl p-6 border border-[#0E1E34] hover:border-[#0099E6]/30 transition-colors">
      ...
      <section className="section bg-[#020B18]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="h2 text-white mb-4">Connects With Your <span className="gt-blue">Entire Stack</span></h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
            {['Binance Liquidity','Coinbase Prime','B2C2 Market Making','Fireblocks Custody','BitGo Custody','Chainalysis AML','Sumsub KYC','Jumio KYC','Stripe Fiat','Banxa On-Ramp','MoonPay','Simplex','TradingView Charts','CoinGecko Data','CoinMarketCap','Twilio 2FA'].map(name => (
              <div key={name} className="flex items-center gap-2.5 p-3 rounded-xl glass border border-[#0E1E34] hover:border-[#0099E6]/30 transition-colors">
