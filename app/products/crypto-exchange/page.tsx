  ...
  return (
    <div className="bg-white">
      ...
      <section className="section relative overflow-hidden grid-bg">
        <div className="orb w-[600px] h-[600px] bg-[#006FEE] opacity-[0.07] -left-40 -top-20" />
                  ...
                  {[['Order Matching Latency','< 0.1ms','99%'],['API Response (REST)','< 5ms','99.9%'],['WebSocket Feed Delay','< 2ms','99.9%'],['System Uptime (SLA)','99.99%','Annual']].map(([lbl, val, ref]) => (
                    <div key={lbl}>
                      ...
                      <div className="h-1.5 bg-slate-200 rounded-full overflow-hidden">
                        <div className="h-full bg-gradient-to-r from-[#006FEE] to-[#00D4FF] rounded-full" style={{ width: ref === '99.99%' ? '99%' : ref === '99.9%' ? '96%' : '90%' }} />
                      </div>
                    </div>
                  ))}
                </div>
