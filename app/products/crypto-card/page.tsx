            ...
            <div className="hidden lg:block">
              <div className="dashboard-preview rounded-2xl relative">
                ...
                <div className="dashboard-bar">
                  ...
                  <span className="ml-3 text-[11px] text-[rgba(240,246,255,0.35)]">cards.yourplatform.com — Card Management</span>
                </div>
                <div className="p-5 space-y-3">
                  ...
                  <div className="rounded-2xl p-4 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #00334466, #001A2A66)', border: `1px solid ${COLOR}33` }}>
                    ...
                    <p className="text-[14px] font-mono text-[#F0F6FF] tracking-widest mb-3">4242 •••• •••• 8741</p>
                    <div className="flex justify-between text-[10px] text-[rgba(240,246,255,0.35)]">
                      <span>Alex K.</span>
                      <span>Exp: 12/27</span>
                    </div>
                  </div>
                  ...
                  <div className="glass rounded-xl p-3">
                    <p className="text-[10px] text-[rgba(240,246,255,0.35)] uppercase tracking-wider mb-2">Recent Transactions</p>
                    {[
                      ['Amazon', '–$84.99', 'USD', '0.0022 ETH'],
                      ['Starbucks', '–$6.50', 'USD', '168 USDT'],
                      ['Netflix', '–$15.99', 'USD', '15.99 USDC'],
                    ].map(([merchant, amount, fiat, crypto]) => (
                      <div key={String(merchant)} className="flex items-center justify-between py-1.5 border-b border-white/[0.06] last:border-0">
                        <span className="text-[11px] font-semibold text-[#F0F6FF]">{merchant}</span>
                        <span className="text-[11px] text-red-400">{amount} {fiat}</span>
                        <span className="text-[10px] text-[rgba(240,246,255,0.35)]">{crypto}</span>
                      </div>
                    ))}
                  </div>
                  {/* Stats */}
      ...
      <section className="section bg-[#0C1428]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="h2 text-[#F0F6FF] mb-4">Everything to Run <span style={{ color: COLOR }}>a Crypto Card Program</span></h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {FEATURES.map(f => (
              <div key={f.title} className="card rounded-2xl p-6 border border-white/[0.06] hover:border-[#00CCFF]/30 transition-colors group">
                <div className="text-3xl mb-4">{f.icon}</div>
                <h3 className="text-[15px] font-bold text-[#F0F6FF] mb-2 group-hover:text-[#7EE8FF] transition-colors">{f.title}</h3>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="h2 text-[#F0F6FF] mb-6">Card-Grade <span style={{ color: COLOR }}>Infrastructure Stack</span></h2>
            ...
            <div>
              ...
              <h3 className="h3 text-[#F0F6FF] mb-6">Card Issuance Technology</h3>
              ...
              <div className="glass-lg rounded-2xl p-6 border border-white/[0.06]">
                <p className="text-[12px] text-[rgba(240,246,255,0.35)] uppercase tracking-wider mb-4">Supported Crypto Assets</p>
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    <div key={String(asset)} className="flex items-start gap-2 p-2 rounded-lg bg-white">
                      ...
                      <div>
                        <p className="text-[12px] font-semibold text-[#F0F6FF]">{asset}</p>
      ...
      <section className="section bg-[#0C1428]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="h2 text-[#F0F6FF] mb-4">Perfect for <span style={{ color: COLOR }}>These Use Cases</span></h2>
          </div>
          <div className="grid md:grid-cols-4 gap-5">
            {[
              ...
              <div key={u.title} className="card rounded-2xl p-6 border border-white/[0.06] hover:border-[#00CCFF]/30 transition-colors">
