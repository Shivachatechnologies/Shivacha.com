            ...
            <div className="hidden lg:block">
              <div className="dashboard-preview rounded-2xl relative">
                ...
                <div className="dashboard-bar">
                  ...
                  <span className="ml-3 text-[11px] text-[#3D5470]">portal.yourbrand.com — Asset Registry</span>
                </div>
                <div className="p-5 space-y-3">
                  ...
                  <div className="flex gap-2 overflow-hidden">
                    {[['Manhattan RE','$24M','Real Estate'],['PrivEQ Fund III','$8M','Private Equity'],['Green Bond 2026','$5M','Fixed Income']].map(([name, val, type]) => (
                      <div key={name} className="glass rounded-lg px-3 py-2 flex-shrink-0 min-w-[110px]">
                        <p className="text-[9px] text-[#3D5470]">{type}</p>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="col-span-2 glass rounded-xl p-3 h-36">
                      <p className="text-[10px] text-[#3D5470] uppercase tracking-wider mb-2">Token Distribution — Manhattan RE</p>
                      <div className="space-y-1.5">
                        {[['Institutional LPs','45%',45],['Family Offices','28%',28],['HNWI Retail','18%',18],['Treasury Reserve','9%',9]].map(([tier, pct, w]) => (
                          <div key={tier}>
                            <div className="flex justify-between text-[9px] mb-0.5">
                              <span className="text-[#7A8FA6]">{tier}</span>
                    ...
                    <div className="glass rounded-xl p-3 h-36 flex flex-col justify-between">
                      <p className="text-[10px] text-[#3D5470] uppercase tracking-wider">Token Info</p>
                      <div className="space-y-1.5">
                        <div><p className="text-[9px] text-[#3D5470]">Standard</p><p className="text-[11px] font-bold" style={{ color: '#00FF87' }}>ERC-3643</p></div>
                        <div><p className="text-[9px] text-[#3D5470]">Total Supply</p><p className="text-[11px] font-bold text-white">24,000,000</p></div>
                        <div><p className="text-[9px] text-[#3D5470]">Investors</p><p className="text-[11px] font-bold text-white">412 KYC'd</p></div>
                      </div>
                    </div>
                  </div>
                  {/* KPI row */}
      ...
      <section className="section bg-[#020B18]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="h2 text-white mb-4">Everything to Tokenize, Distribute & <span style={{ color: '#00FF87' }}>Trade RWAs</span></h2>
            <p className="lead">One compliant platform. From structuring to secondary liquidity — the complete RWA lifecycle.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {FEATURES.map(f => (
              <div key={f.title} className="card rounded-2xl p-6 border border-[#0E1E34] hover:border-[#00FF87]/30 group">
                <div className="text-4xl mb-4">{f.icon}</div>
                <h3 className="text-[16px] font-bold text-white mb-2 group-hover:text-[#00FF87] transition-colors">{f.title}</h3>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="h2 text-white mb-6">Built for <span style={{ color: '#00FF87' }}>Institutional Standards</span></h2>
            ...
            <div>
              ...
              <h3 className="h3 text-white mb-6">The Stack Behind the Tokens</h3>
              ...
              <div className="glass-lg rounded-2xl p-6 border border-[#0E1E34]">
                <p className="text-[12px] text-[#3D5470] uppercase tracking-wider mb-4">Compliance Coverage</p>
      ...
      <section className="section bg-[#020B18]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="h2 text-white mb-4">From Asset to <span style={{ color: '#00FF87' }}>On-Chain Security</span></h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {STEPS.map((s, i) => (
              <div key={s.n} className="card rounded-2xl p-6 border border-[#0E1E34] relative group hover:border-[#00FF87]/30">
                ...
                <h3 className="text-[15px] font-bold text-white mb-2 group-hover:text-[#00FF87] transition-colors">{s.title}</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[['$120M','Portfolio Tokenized in 10 Weeks'],['850+','Accredited Investors — 22 Countries'],['6 Wks','Time to Full Subscription'],['340+','Secondary Market Trades'],['4','Asset Types in Single Platform'],['100%','Automated Quarterly Distributions']].map(([v, l]) => (
                <div key={l} className="glass-lg rounded-2xl p-6 border border-[#0E1E34] hover:border-[#00FF87]/25 transition-colors">
      ...
      <section className="section bg-[#020B18]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="h2 text-white mb-4">Connects With Your <span style={{ color: '#00FF87' }}>Capital Markets Stack</span></h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
            {['Fireblocks Custody','BitGo Custody','Ethereum Mainnet','Polygon zkEVM','Avalanche C-Chain','Sumsub KYC','Jumio Verify','Refinitiv KYC','ComplyAdvantage','Chainalysis','Refinitiv FATCA','OECD CRS Format','DocuSign eSign','IPFS Document Store','The Graph Protocol','Chainlink Oracles'].map(name => (
              <div key={name} className="flex items-center gap-2.5 p-3 rounded-xl glass border border-[#0E1E34] hover:border-[#00FF87]/25 transition-colors">
