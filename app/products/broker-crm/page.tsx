            ...
            <div className="hidden lg:block">
              <div className="dashboard-preview rounded-2xl relative">
                ...
                <div className="dashboard-bar">
                  ...
                  <span className="ml-3 text-[11px] text-[rgba(240,246,255,0.35)]">crm.yourbrokerage.com — Admin</span>
                </div>
                <div className="p-5 space-y-3">
                  ...
                  <div className="glass rounded-xl p-3">
                    <p className="text-[10px] text-[rgba(240,246,255,0.35)] uppercase tracking-wider mb-2">Recent Clients</p>
                    {[
                      ['James W.', 'KYC Approved', 'MT5 Live', '+$5,000'],
                      ['Priya S.', 'Pending KYC', 'Demo', '—'],
                      ['Marco F.', 'KYC Approved', 'MT4 Live', '+$12,400'],
                    ].map(([name, kyc, platform, dep]) => (
                      <div key={String(name)} className="flex items-center justify-between py-1.5 border-b border-white/[0.06] last:border-0">
                        <span className="text-[11px] font-semibold text-[#F0F6FF] w-24">{name}</span>
                        ...
                        <span className="text-[10px] text-[rgba(240,246,255,0.35)]">{platform}</span>
                  ...
                  {/* IB commission strip */}
                  <div className="glass rounded-xl p-3">
                    <p className="text-[10px] text-[rgba(240,246,255,0.35)] uppercase tracking-wider mb-1">IB Commissions This Month</p>
                    <p className="text-[18px] font-black" style={{ color: COLOR }}>$48,240</p>
                    <p className="text-[10px] text-[rgba(240,246,255,0.35)]">across 38 active IBs</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="section bg-[#0C1428]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="h2 text-[#F0F6FF] mb-4">Everything a Modern <span style={{ color: COLOR }}>Broker Needs</span></h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {FEATURES.map(f => (
              <div key={f.title} className="card rounded-2xl p-6 border border-white/[0.06] hover:border-[#006FEE]/30 transition-colors group">
                <div className="text-3xl mb-4">{f.icon}</div>
                <h3 className="text-[15px] font-bold text-[#F0F6FF] mb-2 group-hover:text-[#338EF7] transition-colors">{f.title}</h3>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="h2 text-[#F0F6FF] mb-6">White-Label Ready <span style={{ color: COLOR }}>Out of the Box</span></h2>
            ...
            <div>
              ...
              <h3 className="h3 text-[#F0F6FF] mb-6">Compliance Across 40+ Jurisdictions</h3>
              ...
              <div className="glass-lg rounded-2xl p-6 border border-white/[0.06]">
                <p className="text-[12px] text-[rgba(240,246,255,0.35)] uppercase tracking-wider mb-4">Supported Payment Methods</p>
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    <div key={String(method)} className="flex items-start gap-2 p-2 rounded-lg bg-white">
                      ...
                      <div>
                        <p className="text-[12px] font-semibold text-[#F0F6FF]">{method}</p>
                        <p className="text-[11px] text-[rgba(240,246,255,0.35)]">{detail}</p>
                      </div>
                    </div>
                  ))}
                </div>
      ...
      <section className="section bg-[#0C1428]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="h2 text-[#F0F6FF] mb-4">Built for Every <span style={{ color: COLOR }}>Type of Broker</span></h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={u.title} className="card rounded-2xl p-7 border border-white/[0.06] hover:border-[#006FEE]/30 transition-colors">
