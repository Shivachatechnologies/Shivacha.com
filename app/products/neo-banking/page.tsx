            ...
            <div className="hidden lg:block">
              <div className="dashboard-preview rounded-2xl relative">
                ...
                <div className="dashboard-bar">
                  ...
                  <span className="ml-3 text-[11px] text-[#3D5470]">banking.yourbrand.com — Customer Portal</span>
                </div>
                <div className="p-5 space-y-3">
                  ...
                  <div className="flex gap-3 overflow-hidden">
                    {[['EUR Account','€ 48,230.00','IBAN: DE89 3704'],['USD Account','$ 12,540.00','IBAN: US44 0000'],['GBP Account','£ 6,190.00','IBAN: GB29 NWBK']].map(([label, bal, iban]) => (
                      <div key={label} className="glass rounded-lg px-3 py-2 flex-shrink-0 min-w-[120px]">
                        <p className="text-[9px] text-[#3D5470] uppercase tracking-wide">{label}</p>
                        <p className="text-[13px] font-bold text-white">{bal}</p>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="col-span-2 glass rounded-xl p-3 h-36 flex flex-col gap-1 overflow-hidden">
                      <p className="text-[10px] text-[#3D5470] uppercase tracking-wider mb-1">Recent Transactions</p>
                      {[['SEPA Inbound','+ €12,000','14:32'],['Card Purchase','- €89.50','13:15'],['SWIFT Wire Out','- $5,000','09:00'],['FX Conversion','€ → $','08:40'],['Card Refund','+ €45.00','Yesterday']].map(([desc, amt, time]) => (
                        <div key={desc+time} className="flex justify-between items-center text-[9px]">
                          <span className="text-[#7A8FA6] truncate w-28">{desc}</span>
                          <span className={`font-semibold ${amt.startsWith('+') ? 'text-green-400' : 'text-[#7A8FA6]'}`}>{amt}</span>
                          <span className="text-[#3D5470]">{time}</span>
                        </div>
                      ))}
                    </div>
                    <div className="glass rounded-xl p-3 h-36 flex flex-col justify-between">
                      ...
                      <div className="rounded-lg p-2" style={{ background: 'linear-gradient(135deg, #6644FF44, #33B5E522)' }}>
                        ...
                        <p className="text-[9px] text-[#7A8FA6] mt-1">VISA DEBIT</p>
                        <p className="text-[9px] text-[#3D5470]">Exp 05/28</p>
                      </div>
      ...
      <section className="section bg-[#020B18]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="h2 text-white mb-4">Everything to Run a <span style={{ color: '#8B66FF' }}>Digital Bank</span></h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {FEATURES.map(f => (
              <div key={f.title} className="card rounded-2xl p-6 border border-[#0E1E34] hover:border-[#6644FF]/40 group">
                <div className="text-4xl mb-4">{f.icon}</div>
                <h3 className="text-[16px] font-bold text-white mb-2 group-hover:text-[#8B66FF] transition-colors">{f.title}</h3>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="h2 text-white mb-6">Built for <span style={{ color: '#8B66FF' }}>Regulatory Scale</span></h2>
            ...
            <div>
              ...
              <h3 className="h3 text-white mb-6">The Stack Behind the Bank</h3>
      ...
      <section className="section bg-[#020B18]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="h2 text-white mb-4">From License to <span style={{ color: '#8B66FF' }}>Live Neobank</span></h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {STEPS.map((s, i) => (
              <div key={s.n} className="card rounded-2xl p-6 border border-[#0E1E34] relative group hover:border-[#6644FF]/40">
                ...
                <h3 className="text-[15px] font-bold text-white mb-2 group-hover:text-[#8B66FF] transition-colors">{s.title}</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[['500K','Accounts — First 90 Days'],['$1.2B','Volume — Launch Quarter'],['11 Wks','Contract to Production'],['99.7%','Automated KYC Pass Rate'],['99.99%','Uptime — First Year'],['Zero','Fraud Loss Events']].map(([v, l]) => (
                <div key={l} className="glass-lg rounded-2xl p-6 border border-[#0E1E34] hover:border-[#6644FF]/30 transition-colors">
      ...
      <section className="section bg-[#020B18]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="h2 text-white mb-4">Connects With Your <span style={{ color: '#8B66FF' }}>Banking Stack</span></h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
            {['Temenos Transact','Oracle FLEXCUBE','Finacle Core','Visa DPS','Mastercard MDES','Sumsub KYC','Jumio Verify','Onfido','ComplyAdvantage','Chainalysis AML','SWIFT gpi','SEPA Instant','Stripe Treasury','Modulr Payments','Railsr BaaS','Twilio Verify'].map(name => (
              <div key={name} className="flex items-center gap-2.5 p-3 rounded-xl glass border border-[#0E1E34] hover:border-[#6644FF]/30 transition-colors">
