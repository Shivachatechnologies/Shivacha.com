...
const POSTS = [
  { tag: 'Blockchain', color: '#006FEE', title: 'The State of DeFi in 2025: Institutional Adoption and Enterprise Requirements', excerpt: 'As institutional DeFi adoption accelerates, we break down the key protocols, compliance frameworks, and infrastructure requirements.', author: 'Shivacha Research', date: 'May 15, 2025', readTime: '8 min', href: '/blog/defi-institutional-2025' },
  ...
  return (
    <div className="bg-white">
      <section className="section relative overflow-hidden grid-bg">
        <div className="orb w-96 h-96 bg-[#006FEE] opacity-[0.06] right-0 top-0" />
