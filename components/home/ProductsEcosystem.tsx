...
const PRODUCTS = [
  {
    ...
    line: 'CEX & DEX — 100K+ TPS matching engine',
    href: '/products/crypto-exchange',
    badge: 'Most Popular',
    accent: '#006FEE',
    stat1: '100K TPS', stat2: '99.99% SLA',
  },
  {
    name: 'Neo Banking',
    line: 'Virtual IBANs, SWIFT/SEPA, card issuance',
    href: '/products/neo-banking',
    badge: null,
    accent: '#8B5CF6',
    stat1: '180+ currencies', stat2: 'PSD2 ready',
  },
  {
    name: 'AI Agent Platform',
    line: 'Autonomous AI for trading & compliance',
    href: '/products/ai-agents',
    badge: 'New',
    accent: '#06B6D4',
    stat1: '15+ AI models', stat2: '98.5% accuracy',
  },
  {
    name: 'Tokenization Engine',
    line: 'RWA tokenization — ERC-3643 compliant',
    href: '/products/tokenization',
    badge: 'New',
    accent: '#10B981',
    stat1: '20+ asset types', stat2: '30+ jurisdictions',
  },
  {
    name: 'Forex Infrastructure',
    line: 'MT4/MT5 bridge, liquidity & risk engine',
    href: '/products/forex',
    badge: null,
    accent: '#F59E0B',
    stat1: '2000+ instruments', stat2: '<10ms execution',
  },
  {
    name: 'Trading Bots',
    line: 'Strategy builder, backtest & live deploy',
    href: '/products/trading-bots',
    badge: null,
    accent: '#EF4444',
    stat1: '30+ exchanges', stat2: '50+ strategies',
  },
  {
    name: 'Enterprise Wallet',
    line: 'MPC custody across 50+ blockchains',
    href: '/products/wallet',
    badge: null,
    accent: '#6366F1',
    stat1: '50+ chains', stat2: 'HSM + MPC',
  },
  {
    name: 'Crypto Debit Card',
    line: 'Visa/Mastercard issuance in 30+ countries',
    href: '/products/crypto-card',
    badge: null,
    accent: '#0EA5E9',
    stat1: 'Visa & MC', stat2: 'Real-time FX',
  },
  {
    name: 'Broker CRM',
    line: 'IB tree, commissions & KYC workflows',
    href: '/products/broker-crm',
    badge: null,
    accent: '#EC4899',
    stat1: 'Full IB tree', stat2: 'Commission engine',
  },
  {
    name: 'Cloud & VPS',
    line: 'Bare-metal & Kubernetes for fintech workloads',
    href: '/products/cloud',
    badge: null,
    accent: '#14B8A6',
    stat1: '99.99% SLA', stat2: 'DDoS protected',
  },
];

/* SVG icon per product */
...
export default function ProductsEcosystem() {
  return (
    <section className="section bg-slate-50 border-y border-slate-200" id="products">
      <div className="container">
        ...
        {/* Product grid — clean, icon-forward */}
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3">
          {PRODUCTS.map((p) => (
            <Link key={p.href} href={p.href}
              className="group bg-white border border-slate-200 hover:border-slate-300 rounded-2xl p-5 transition-all hover:shadow-[0_8px_28px_rgba(0,0,0,0.07)] hover:-translate-y-1 flex flex-col relative overflow-hidden">
              ...
              {/* Icon */}
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4 flex-shrink-0 transition-colors"
              ...
              <div className="flex items-start justify-between gap-2 mb-1.5">
                <h3 className="text-[14px] font-bold text-slate-900 group-hover:text-[#006FEE] transition-colors leading-snug">
                  {p.name}
                </h3>
                {p.badge && (
              ...
              {/* One-liner */}
              <p className="text-[12px] text-slate-400 leading-relaxed mb-4 flex-1">{p.line}</p>
        ...
        {/* Bottom CTA strip */}
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-between gap-4 bg-white border border-slate-200 rounded-2xl px-7 py-5">
          <div>
            <p className="text-[15px] font-bold text-slate-900">Need a custom solution?</p>
            <p className="text-[13px] text-slate-400 mt-0.5">We build bespoke infrastructure for unique requirements.</p>
          </div>
