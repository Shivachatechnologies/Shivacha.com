            ...
            <div className="grid grid-cols-2 gap-4">
              {AWARDS.map((a) => (
                <div key={a.title}
                  ...
                  <div>
                    <p className="text-[13px] font-semibold text-white leading-tight mb-1 group-hover:text-[#33B5E5] transition-colors">
                      {a.title}
                    </p>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {CERTIFICATIONS.map((c) => (
                <div key={c.name}
                  className="card rounded-2xl p-5 border border-[#0E1E34] hover:border-[#0099E6]/40 group text-center">
