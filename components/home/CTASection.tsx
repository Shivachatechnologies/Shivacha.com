...
export default function CTASection() {
  return (
    <section className="section bg-slate-50 relative overflow-hidden border-t border-slate-200">
      {/* Background effects */}
      ...
      <div className="container relative z-10 text-center">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <h2 className="h1 text-slate-900 mb-6">
            Ready to Build Your
            <br />
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="glass rounded-2xl p-6 border border-slate-200 hover:border-slate-300 transition-colors group">
              ...
              <h3 className="text-[15px] font-bold text-slate-900 mb-2">Schedule a Call</h3>
              <p className="text-[13px] text-slate-400 mb-4">Book a 30-min discovery call with our enterprise team</p>
            ...
            <div className="glass rounded-2xl p-6 border border-slate-200 hover:border-slate-300 transition-colors group">
              ...
              <h3 className="text-[15px] font-bold text-slate-900 mb-2">Send a Brief</h3>
              <p className="text-[13px] text-slate-400 mb-4">Share your project brief and get a detailed proposal in 24h</p>
            ...
            <div className="glass rounded-2xl p-6 border border-slate-200 hover:border-slate-300 transition-colors group">
              ...
              <h3 className="text-[15px] font-bold text-slate-900 mb-2">Speak Directly</h3>
              <p className="text-[13px] text-slate-400 mb-4">Call our enterprise team in USA, India, or UK — available 24/7</p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={o.country} className="text-left glass rounded-2xl p-5 border border-slate-200">
              <div className="flex items-center gap-2 mb-3">
                <span className="text-2xl">{o.flag}</span>
                <span className="text-[15px] font-bold text-slate-900">{o.country}</span>
              </div>
              <p className="text-[13px] text-slate-400 whitespace-pre-line mb-2">{o.address}</p>
              <a href={`tel:${o.phone.replace(/\s/g,'')}`} className="text-[13px] text-[#33B5E5] hover:text-[#0099E6] transition-colors block">{o.phone}</a>
              <a href={`mailto:${o.email}`} className="text-[13px] text-slate-400 hover:text-[#33B5E5] transition-colors block">{o.email}</a>
            </div>
          ))}
        </div>
      </div>
